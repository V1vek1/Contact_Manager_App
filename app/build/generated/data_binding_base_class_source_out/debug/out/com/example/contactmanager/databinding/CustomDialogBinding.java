...
public final class CustomDialogBinding implements ViewBinding {
  ...
  private CustomDialogBinding(@NonNull LinearLayout rootView, @NonNull Button btnOk,
  ...
  public static CustomDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomDialogBinding((LinearLayout) rootView, btnOk, imageView, textView);
    }
